...
from k_means_plot import get_tasks_embeddings, read_examples, load_embedding_model, dim_reduction
...
def main():
    ...
    # figure_path = "/usr/workdir/HeterExpert/domains/tasks_distribution.pdf"
    ...
    for idx, domain in enumerate(domains_data_merge):
        domain_path = f'/usr/workdir/HeterExpert/domains/domain{idx}'
