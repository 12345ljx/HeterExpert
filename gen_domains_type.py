...
from gen_domains_cluster import merge_domain_data
...
def main():
    ...
    for idx, domain in enumerate(domains_data_merge):
        domain_path = f'/usr/workdir/HeterExpert/domains/task_type/domain{idx}'
        domain.save_to_disk(domain_path)
    np.save('/usr/workdir/HeterExpert/domains/task_type/domains_compose.npy', domains_compose)
