...
from pre_cluster import NUM_MODULES
from ilp_solver import NUM_EXPERT, NUM_HIDDEN_LAYERS
...
for layer_idx in range(NUM_HIDDEN_LAYERS):
    placement = np.load(f'/usr/workdir/HeterExpert/Neuron_Importance/ilp_split/raw_data/{NUM_EXPERT}/neuron_grouping.layer{layer_idx}.npz')['placement']  # [num_neurons,]
    ...
    with open(f'/usr/workdir/HeterExpert/Split/model_split/ilp/{model_name}/{function_name}/{NUM_EXPERT}/{layer_idx}.part.{NUM_EXPERT}', 'w') as f:
