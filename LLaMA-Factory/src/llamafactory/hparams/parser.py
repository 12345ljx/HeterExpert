...
from .moefication_args import MoEArguments
...
_TRAIN_ARGS = [ModelArguments, MoEArguments, DataArguments, Seq2SeqTrainingArguments, FinetuningArguments, GeneratingArguments]
...
def get_train_args(args: Optional[Dict[str, Any]] = None) -> _TRAIN_CLS:
    model_args, moe_args, data_args, training_args, finetuning_args, generating_args = _parse_train_args(args)
    ...
    return model_args, moe_args, data_args, training_args, finetuning_args, generating_args
