...
class FinetuningArguments(FreezeArguments, LoraArguments, RLHFArguments, GaloreArguments, BAdamArgument):
    ...
    """
    training_parts: Literal["gate", "lora", "mix_gate", "gate,lora"] = field(
        default="gate",
        metadata={"help": "The training_parts of the model."},
    )
    ...
    def __post_init__(self):
        ...
        if self.finetuning_type == "lora" and "lora" not in self.training_parts:
            raise ValueError()
        
        if self.finetuning_type == "freeze" and self.training_parts not in ("gate", "mix_gate"):
            raise ValueError()
